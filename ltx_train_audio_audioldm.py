...
from audioldm_vae.dataset_audio_audioldm import AudioLDM_dataset
...
class Trainer:
    ...
    def prepare_dataset(self) -> None:
        ...
        self.dataset = AudioLDM_dataset(device=self.state.accelerator.device, split="train", prefix=self.args.prefix)
